...
goog.exportSymbol('proto.sfu.SessionDescription', null, global);
 ...
 * @constructor
 */
proto.sfu.SessionDescription = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.sfu.SessionDescription, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.sfu.SessionDescription.displayName = 'proto.sfu.SessionDescription';
}
 ...
 * @const
 */
proto.sfu.SignalRequest.oneofGroups_ = [[1,2,3]];
...
proto.sfu.SignalRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    negotiate: (f = msg.getNegotiate()) && proto.sfu.SessionDescription.toObject(includeInstance, f),
...
proto.sfu.SignalRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.sfu.SessionDescription;
      reader.readMessage(value,proto.sfu.SessionDescription.deserializeBinaryFromReader);
      msg.setNegotiate(value);
      break;
    case 3:
...
proto.sfu.SignalRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getNegotiate();
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      proto.sfu.SessionDescription.serializeBinaryToWriter
    );
  }
...
proto.sfu.SignalRequest.prototype.getJoin = function() {
  return /** @type{?proto.sfu.JoinRequest} */ (
    jspb.Message.getWrapperField(this, proto.sfu.JoinRequest, 1));
};
...
proto.sfu.SignalRequest.prototype.setJoin = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.sfu.SignalRequest.oneofGroups_[0], value);
};
...
/**
 * optional SessionDescription negotiate = 2;
 * @return {?proto.sfu.SessionDescription}
 */
proto.sfu.SignalRequest.prototype.getNegotiate = function() {
  return /** @type{?proto.sfu.SessionDescription} */ (
    jspb.Message.getWrapperField(this, proto.sfu.SessionDescription, 2));
};


/**
 * @param {?proto.sfu.SessionDescription|undefined} value
 * @return {!proto.sfu.SignalRequest} returns this
*/
proto.sfu.SignalRequest.prototype.setNegotiate = function(value) {
 ...
 * @return {!proto.sfu.SignalRequest} returns this
 */
proto.sfu.SignalRequest.prototype.clearNegotiate = function() {
  return this.setNegotiate(undefined);
};
 ...
 * @return {boolean}
 */
proto.sfu.SignalRequest.prototype.hasNegotiate = function() {
...
proto.sfu.SignalRequest.prototype.getTrickle = function() {
  return /** @type{?proto.sfu.Trickle} */ (
    jspb.Message.getWrapperField(this, proto.sfu.Trickle, 3));
};
...
proto.sfu.SignalRequest.prototype.setTrickle = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.sfu.SignalRequest.oneofGroups_[0], value);
};
 ...
 * @const
 */
proto.sfu.SignalReply.oneofGroups_ = [[1,2,3]];
...
proto.sfu.SignalReply.prototype.getJoin = function() {
  return /** @type{?proto.sfu.JoinReply} */ (
    jspb.Message.getWrapperField(this, proto.sfu.JoinReply, 1));
};
...
proto.sfu.SignalReply.prototype.setJoin = function(value) {
  return jspb.Message.setOneofWrapperField(this, 1, proto.sfu.SignalReply.oneofGroups_[0], value);
};
 ...
 * @return {?proto.sfu.SessionDescription}
 */
proto.sfu.SignalReply.prototype.getNegotiate = function() {
  return /** @type{?proto.sfu.SessionDescription} */ (
    jspb.Message.getWrapperField(this, proto.sfu.SessionDescription, 2));
};
 ...
 * @return {!proto.sfu.SignalReply} returns this
*/
proto.sfu.SignalReply.prototype.setNegotiate = function(value) {
 ...
 * @return {!proto.sfu.SignalReply} returns this
 */
proto.sfu.SignalReply.prototype.clearNegotiate = function() {
  return this.setNegotiate(undefined);
};
 ...
 * @return {boolean}
 */
proto.sfu.SignalReply.prototype.hasNegotiate = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.sfu.SignalReply.prototype.setTrickle = function(value) {
  return jspb.Message.setOneofWrapperField(this, 3, proto.sfu.SignalReply.oneofGroups_[0], value);
};
...
proto.sfu.JoinRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    offer: (f = msg.getOffer()) && proto.sfu.SessionDescription.toObject(includeInstance, f)
  };
...
/**
 * optional SessionDescription offer = 2;
 * @return {?proto.sfu.SessionDescription}
 */
proto.sfu.JoinRequest.prototype.getOffer = function() {
  return /** @type{?proto.sfu.SessionDescription} */ (
    jspb.Message.getWrapperField(this, proto.sfu.SessionDescription, 2));
};
 ...
 * @return {!proto.sfu.JoinRequest} returns this
*/
proto.sfu.JoinRequest.prototype.setOffer = function(value) {
 ...
 * @return {!proto.sfu.JoinRequest} returns this
 */
proto.sfu.JoinRequest.prototype.clearOffer = function() {
 ...
 * @return {boolean}
 */
proto.sfu.JoinRequest.prototype.hasOffer = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.sfu.JoinReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    answer: (f = msg.getAnswer()) && proto.sfu.SessionDescription.toObject(includeInstance, f)
  };
 ...
 * @return {string}
 */
proto.sfu.JoinReply.prototype.getPid = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.sfu.JoinReply.prototype.setPid = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional SessionDescription answer = 2;
 * @return {?proto.sfu.SessionDescription}
 */
proto.sfu.JoinReply.prototype.getAnswer = function() {
  return /** @type{?proto.sfu.SessionDescription} */ (
    jspb.Message.getWrapperField(this, proto.sfu.SessionDescription, 2));
};
 ...
 * @return {!proto.sfu.JoinReply} returns this
*/
proto.sfu.JoinReply.prototype.setAnswer = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.sfu.JoinReply} returns this
 */
proto.sfu.JoinReply.prototype.clearAnswer = function() {
 ...
 * @return {boolean}
 */
proto.sfu.JoinReply.prototype.hasAnswer = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.sfu.Trickle.toObject = function(includeInstance, msg) {
  var f, obj = {
    init: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * @return {!Object}
 */
proto.sfu.SessionDescription.prototype.toObject = function(opt_includeInstance) {
  return proto.sfu.SessionDescription.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.sfu.SessionDescription} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sfu.SessionDescription.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.sfu.SessionDescription}
 */
proto.sfu.SessionDescription.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.sfu.SessionDescription;
  return proto.sfu.SessionDescription.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.sfu.SessionDescription} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.sfu.SessionDescription}
 */
proto.sfu.SessionDescription.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.sfu.SessionDescription.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.sfu.SessionDescription.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.sfu.SessionDescription} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.sfu.SessionDescription.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.sfu.SessionDescription.prototype.getType = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.sfu.SessionDescription} returns this
 */
proto.sfu.SessionDescription.prototype.setType = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};


/**
 * optional bytes sdp = 2;
 * @return {!(string|Uint8Array)}
 */
proto.sfu.SessionDescription.prototype.getSdp = function() {
 ...
 * @return {string}
 */
proto.sfu.SessionDescription.prototype.getSdp_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.sfu.SessionDescription.prototype.getSdp_asU8 = function() {
 ...
 * @return {!proto.sfu.SessionDescription} returns this
 */
proto.sfu.SessionDescription.prototype.setSdp = function(value) {
