...
goog.exportSymbol('proto.rtc.VideoInfo', null, global);
/**
 ...
 * @constructor
 */
proto.rtc.VideoInfo = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.rtc.VideoInfo, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.rtc.VideoInfo.displayName = 'proto.rtc.VideoInfo';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.rtc.VideoInfo.prototype.toObject = function(opt_includeInstance) {
  return proto.rtc.VideoInfo.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.rtc.VideoInfo} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rtc.VideoInfo.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 */
proto.rtc.VideoInfo.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.rtc.VideoInfo;
  return proto.rtc.VideoInfo.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.rtc.VideoInfo} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.rtc.VideoInfo}
 */
proto.rtc.VideoInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.rtc.VideoInfo.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.rtc.VideoInfo.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.rtc.VideoInfo} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.rtc.VideoInfo.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWidth();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.rtc.VideoInfo.prototype.getWidth = function() {
...
/**
 * @param {number} value
 * @return {!proto.rtc.VideoInfo} returns this
 */
proto.rtc.VideoInfo.prototype.setWidth = function(value) {
 ...
 * @return {number}
 */
proto.rtc.VideoInfo.prototype.getHeight = function() {
 ...
 * @return {!proto.rtc.VideoInfo} returns this
 */
proto.rtc.VideoInfo.prototype.setHeight = function(value) {
 ...
 * @return {!proto.rtc.VideoInfo} returns this
 */
proto.rtc.VideoInfo.prototype.setFramerate = function(value) {
 ...
 * @return {!jspb.Map<string,string>}
 */
proto.rtc.VideoInfo.prototype.getSimulcastMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
 ...
 * @return {!proto.rtc.VideoInfo} returns this
 */
proto.rtc.VideoInfo.prototype.clearSimulcastMap = function() {
...
proto.rtc.TrackInfo.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      proto.rtc.VideoInfo.serializeBinaryToWriter
    );
  }
};
