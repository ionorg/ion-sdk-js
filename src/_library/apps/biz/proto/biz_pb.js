...
var proto_ion_ion_pb = require('../../../proto/ion/ion_pb.js');
goog.object.extend(proto, proto_ion_ion_pb);
...
proto.biz.Join.toObject = function(includeInstance, msg) {
  var f, obj = {
    peer: (f = msg.getPeer()) && proto_ion_ion_pb.Peer.toObject(includeInstance, f),
...
proto.biz.Join.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto_ion_ion_pb.Peer;
      reader.readMessage(value,proto_ion_ion_pb.Peer.deserializeBinaryFromReader);
      msg.setPeer(value);
      break;
    case 2:
...
proto.biz.Join.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto_ion_ion_pb.Peer.serializeBinaryToWriter
    );
  }
  f = message.getToken();
  if (f.length > 0) {
...
proto.biz.Join.prototype.getPeer = function() {
  return /** @type{?proto.ion.Peer} */ (
    jspb.Message.getWrapperField(this, proto_ion_ion_pb.Peer, 1));
};
...
proto.biz.SignalRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    msg: (f = msg.getMsg()) && proto_ion_ion_pb.Message.toObject(includeInstance, f)
  };
...
proto.biz.SignalRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 4:
      var value = new proto_ion_ion_pb.Message;
      reader.readMessage(value,proto_ion_ion_pb.Message.deserializeBinaryFromReader);
      msg.setMsg(value);
      break;
    default:
      reader.skipField();
...
proto.biz.SignalRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto_ion_ion_pb.Message.serializeBinaryToWriter
    );
  }
};
...
proto.biz.SignalRequest.prototype.getMsg = function() {
  return /** @type{?proto.ion.Message} */ (
    jspb.Message.getWrapperField(this, proto_ion_ion_pb.Message, 4));
};
...
proto.biz.SignalReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    peerevent: (f = msg.getPeerevent()) && proto_ion_ion_pb.PeerEvent.toObject(includeInstance, f),
    streamevent: (f = msg.getStreamevent()) && proto_ion_ion_pb.StreamEvent.toObject(includeInstance, f),
    msg: (f = msg.getMsg()) && proto_ion_ion_pb.Message.toObject(includeInstance, f)
  };
...
proto.biz.SignalReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto_ion_ion_pb.PeerEvent;
      reader.readMessage(value,proto_ion_ion_pb.PeerEvent.deserializeBinaryFromReader);
      msg.setPeerevent(value);
      break;
    case 4:
      var value = new proto_ion_ion_pb.StreamEvent;
      reader.readMessage(value,proto_ion_ion_pb.StreamEvent.deserializeBinaryFromReader);
...
proto.biz.SignalReply.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto_ion_ion_pb.PeerEvent.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto_ion_ion_pb.StreamEvent.serializeBinaryToWriter
    );
  }
  f = message.getMsg();
  if (f != null) {
...
proto.biz.SignalReply.prototype.getPeerevent = function() {
  return /** @type{?proto.ion.PeerEvent} */ (
    jspb.Message.getWrapperField(this, proto_ion_ion_pb.PeerEvent, 3));
};
...
proto.biz.SignalReply.prototype.getStreamevent = function() {
  return /** @type{?proto.ion.StreamEvent} */ (
    jspb.Message.getWrapperField(this, proto_ion_ion_pb.StreamEvent, 4));
};
...
proto.biz.SignalReply.prototype.getMsg = function() {
  return /** @type{?proto.ion.Message} */ (
    jspb.Message.getWrapperField(this, proto_ion_ion_pb.Message, 5));
};
