...
var Client = /** @class */ (function (_super) {
    ...
    Client.prototype.publish = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        stream_1 = new Stream_1.default();
                        return [4 /*yield*/, stream_1.init(true, {
                                audio: options.audio,
                                video: options.video,
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this._createSender(stream_1.stream, options.codec)];
                    case 3:
                        pc_1 = _a.sent();
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        console.log("Send offer sdp => " + (offer === null || offer === void 0 ? void 0 : offer.sdp));
                                        // @ts-ignore
                                        pc_1.sendOffer = true;
                                    ...
                                    case 2:
                                        ...
                                        stream_1.mid = result === null || result === void 0 ? void 0 : result.mid;
                                        this._streams[stream_1.mid] = stream_1;
                                        this._pcs[stream_1.mid] = pc_1;
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                pc_2.onaddstream = function (e) {
                                    var stream = new Stream_1.default(sub_mid, e.stream);
                                    console.log("Stream::pc::onaddstream", stream.mid);
                                    _this._streams[sub_mid] = stream;
                                    resolve(stream);
                                };
                                // @ts-ignore : deprecated api
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                ...
                                                console.log("Send offer sdp => " + (jsep === null || jsep === void 0 ? void 0 : jsep.sdp));
                                                // @ts-ignore : deprecated api
                                                pc_2.sendOffer = true;
                                            ...
                                            case 1:
                                                ...
                                                console.log("subscribe success => result(mid: " +
                                                    sub_mid +
                                                    ") sdp => " + (result === null || result === void 0 ? void 0 : result.jsep.sdp));
