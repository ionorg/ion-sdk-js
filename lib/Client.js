...
var Client = /** @class */ (function (_super) {
    ...
    function Client(url, debug) {
        ...
        _this._url = _this._getProtooUrl(url, _this._uid);
        _this._pcs = {};
        _this._streams = {};
        return _this;
    }
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                ...
                                                case 2:
                                                    _b.sent();
                                                    if (this._debug)
                                                        console.log("publish success ", result === null || result === void 0 ? void 0 : result.mid);
                                                    this._streams[result === null || result === void 0 ? void 0 : result.mid] = stream;
                                                    this._pcs[result === null || result === void 0 ? void 0 : result.mid] = pc_1;
                                                    resolve(result === null || result === void 0 ? void 0 : result.mid);
                                                    _b.label = 3;
                                                case 3: return [2 /*return*/];
                                            }
                                        });
    ...
    Client.prototype.updateTracks = function (mid, tracks) {
        var _this = this;
        this._pcs[mid].getSenders().forEach(function (sender) { return __awaiter(_this, void 0, void 0, function () {
            var nextTrack;
            var _a;
            return __generator(this, function (_b) {
                nextTrack = tracks.find(function (track) { var _a; return track.kind === ((_a = sender === null || sender === void 0 ? void 0 : sender.track) === null || _a === void 0 ? void 0 : _a.kind); });
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    ...
                                    pc_2.onnegotiationneeded = function () {
                                        console.log("negotiation needed");
                                    };
                                    pc_2.ontrack = function () {
    ...
    Client.prototype.broadcast = function (rid, info) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var data, error_7;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, ((_a = this._protoo) === null || _a === void 0 ? void 0 : _a.request("broadcast", {
                                rid: rid,
                                uid: this._uid,
                                info: info,
                            }))];
                    ...
                    case 2:
                        error_7 = _b.sent();
                        if (this._debug)
                            console.log("broadcast reject: error =>" + error_7);
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/];
                }
            });
    ...
    Client.prototype._getProtooUrl = function (baseUrl, pid) {
    ...
    Client.prototype._handleNotification = function (notification) {
        ...
        switch (method) {
            ...
            case "broadcast": {
                var rid = data.rid, uid = data.uid, info = data.info;
                // if (this._debug)
                //   console.log("broadcast peer rid => %s, uid => %s", rid, uid);
